...
vars=(gw,FSNT,FSNTC,FLNT,FLNTC,FSNS,FSNSC,FLNS,FLNSC,LHFLX,SHFLX,PRECC,PRECL,SWCF,LWCF,U,V,OMEGA,CLDLOW,CLDHGH,TGCLDLWP,T,Q,AREL,sgm_tota,sgm_shal,sgm_turb,DCCLDLIQ,ZMDLIQ,DPDLFLIQ,CMFDLIQ,SHDLFLIQ,MACPDLIQ,MPDLIQ,VDCLDLIQ,DCQ,ZMDQ,CMFDQ,MACPDQ,MPDQ,VD01,DTCOND,ZMDT,DPDLFT,CMFDT,SHDLFT,MACPDT,MPDT,DTV,RELHUM,OCNFRAC,alst_def,alst_gp,CLOUD,TS,TREFHT,aa_gp,bb_gp,beta_gp,delta_q,deltaq_uns,deltaq_sat,N1,qtu_shal,thlu_shal,umf_shal,clddep2,wstarPBL,lengi,shi,FREQSH,CMFMC,dqwdz,dthldz,qw2,thl2,qwthl,qwu_qw,thlu_thl,qwu_thlu) # for f19f19

#vars=(gw,FSNT,FSNTC,FLNT,FLNTC,FSNS,FSNSC,FLNS,FLNSC,LHFLX,SHFLX,PRECC,PRECL,SWCF,LWCF,U,V,OMEGA,CLDLOW,CLDHGH,TGCLDLWP,T,Q,AREL,DCCLDLIQ,ZMDLIQ,DPDLFLIQ,CMFDLIQ,SHDLFLIQ,MACPDLIQ,MPDLIQ,VDCLDLIQ,DCQ,ZMDQ,CMFDQ,MACPDQ,MPDQ,VD01,DTCOND,ZMDT,DPDLFT,CMFDT,SHDLFT,MACPDT,MPDT,DTV,RELHUM,OCNFRAC,CLOUD,TS,TREFHT,FREQSH,CMFMC)
